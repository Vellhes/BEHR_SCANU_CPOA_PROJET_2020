...
Dans la fenêtre de gestion de commande le remplissage d'une ChoiceBox empêche la fenêtre de se créer nous avons donc dû le retirer.

Répartition du travail :
BEHR Malo :
Interface graphique : Ajout Ligne Commande, Catégorie, Gestion Catégorie.
Code : Ajout Commande, Catégorie, Produit, Ligne Commande,    Gestion Client, Produit, Commande.
65 / 70 %

SCANU Antoine :
Interface Graphique : Ajout Commande, Produit, Client,   Gestion Client, Produit, Commande.
Code : Ajout Client,   Gestion Catégorie.
30 / 35 %
